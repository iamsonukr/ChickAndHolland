          ...
          <div className="relative flex flex-wrap gap-1">
              ...
              placeholder={
                hidePlaceholderWhenSelected && selected.length !== 0
                  ...
                  : selected.length >= maxSelected
                    ? `${maxSelected} option(s) already selected, remove it to select new ones`
                    : placeholder
              }
              className={cn(
            ...
            <button
              ...
              className={cn(
                ...
                // if showBadgesVertically is true, we should center the clear all button. else, we should keep it as above
